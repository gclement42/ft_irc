...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/28 12:25:41 by lboulatr          #+#    #+#             */
/*   Updated: 2023/11/28 12:25:43 by lboulatr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ERR_USERONCHANNEL(nickname, channelName) ":irc 443 " + nickname + " " + channelName + " :is already on channel\r\n"
# define ERR_NEEDMOREPARAMSMODE(nickname, channel, mode) ":irc 461 PRIVMSG " + channel + " " + nickname + " " + mode + " :Not enough parameters\r\n"

# define ERR_BADFORMATMODE() "MODE :Bad format mode\r\n"
# define ERR_ISNOTOPER(nickname) nickname + " : Is not an IRC operator\r\n"
# define ERR_UNKNOWNMODE(nickname, channel, mode) ":irc 472 PRIVMSG " + channel + " " + nickname + " " + mode + " :is unknown mode char to me\r\n"
